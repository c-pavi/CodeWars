...
function nbMonths(startPriceOld, startPriceNew, savingperMonth, percentLossByMonth){
    let savings = 0
    let reduc = (100-percentLossByMonth)/100
    let months = 0
    
    if(startPriceOld + savings >= startPriceNew){return [0,Math.abs(startPriceOld - startPriceNew)]}
    
    do{
      if(months != 0 & months%2 == 1){ reduc -= 0.005}
      months ++
      startPriceOld *=reduc
      startPriceNew *=reduc
